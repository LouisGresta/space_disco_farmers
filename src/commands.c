...
void process_spaceship(char** params, Ship* spaceships, uint16_t* nb_spaceships)
{
...
int parse_radar_response(const char* response, Planet* planets, Ship* spaceships, uint16_t* nb_planets, uint16_t* nb_spaceships, uint16_t* x_base, uint16_t* y_base) {
    uint16_t count;
